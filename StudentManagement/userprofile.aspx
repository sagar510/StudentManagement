<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="userprofile.aspx.cs" Inherits="StudentManagement.WebForm6" %>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    <asp:TextBox CssClass="form-control" ID="TextBox2" runat="server" TextMode="DateTime"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <center>
                                    <img width="100px" height="100px" src="images/Studenticon1.jpg" />
                                </center>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <center>
                                <h4>Update Log</h4>
                                <span class="badge rounded-pill bg-info">Info about updates made</span>
                                </center>
                            </div> 
                        </div>
                        <div class="row">
